...
import com.reflex.widgethub.ui.performWidgetHaptic
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ACTION_INCREMENT -> {
                ...
                val goal = updated.goal.coerceAtLeast(1)
                val goalReached = updated.currentCount > 0 && updated.currentCount % goal == 0L
                performWidgetHaptic(context, goalReached)
            }
